...
DOCUMENT_PACKS: tuple[DocumentPack, ...] = (
    ...
    DocumentPack(
        pack_id="identity-cl-front-back",
        document_family="identity",
        country="CL",
        variant="identity-cl-front-back-text",
        version="2026-03",
        label="Cedula Chile frente+dorso",
        ...
        expected_fields=(
            ...
            PackFieldDefinition("document_number", "Numero de documento", aliases=("numero-de-documento", "numero", "documento", "numero-documento"), required=True, critical=True),
            PackFieldDefinition("run", "RUN", aliases=("run",), required=True, critical=True),
            PackFieldDefinition("birth_date", "Fecha de nacimiento", aliases=("fecha-de-nacimiento",), required=True, critical=True),
            PackFieldDefinition("issue_date", "Fecha de emision", aliases=("fecha-de-emision",), required=True),
            PackFieldDefinition("expiry_date", "Fecha de vencimiento", aliases=("fecha-de-vencimiento",), required=True, critical=True),
            PackFieldDefinition("sex", "Sexo", aliases=("sexo",), required=True),
            PackFieldDefinition("birth_place", "Lugar de nacimiento", aliases=("lugar-de-nacimiento", "nacio-en"), required=True),
            PackFieldDefinition("mrz", "MRZ", aliases=("mrz",), required=True, critical=True),
        ),
        decision_thresholds=PackDecisionThresholds(auto_accept_confidence=0.95, auto_accept_agreement=0.82, accept_with_warning_confidence=0.86, review_agreement=0.55),
        min_back_fields=1,
    ),
    DocumentPack(
    ...
    DocumentPack(
        pack_id="driver-license-cl-front",
        document_family="driver_license",
        country="CL",
        variant="driver-license-cl-front-text",
        version="2026-03",
        label="Licencia Chile frente",
        document_side="front",
        classification_keywords=("LICENCIA", "CONDUC", "CLASE", "NOMBRES", "APELLIDOS", "CHILE"),
        expected_fields=(
            PackFieldDefinition("holder_name", "Titular", aliases=("nombre-completo", "titular", "nombres", "apellidos"), required=True, critical=True),
            PackFieldDefinition("document_number", "Numero de documento", aliases=("license-number", "numero-de-documento", "numero"), required=True, critical=True),
            PackFieldDefinition("run", "RUN", aliases=("run",), required=False),
            PackFieldDefinition("birth_date", "Fecha de nacimiento", aliases=("fecha-de-nacimiento",), required=False),
            PackFieldDefinition("issue_date", "Fecha de emision", aliases=("issue-date", "fecha-de-emision"), required=False),
            PackFieldDefinition("expiry_date", "Fecha de vencimiento", aliases=("expiry-date", "fecha-de-vencimiento"), required=False),
            PackFieldDefinition("categories", "Categorias", aliases=("categories", "class", "categoria", "categorias"), required=False),
            PackFieldDefinition("authority", "Autoridad", aliases=("authority", "autoridad", "municipalidad"), required=False),
        ),
        decision_thresholds=PackDecisionThresholds(auto_accept_confidence=0.93, auto_accept_agreement=0.78, accept_with_warning_confidence=0.82, review_agreement=0.48),
    ),
    DocumentPack(
