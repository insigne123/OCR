...
import { getPublicSubmissionOrThrow, buildPublicSubmissionStatus } from "@/lib/public-api-status";
...
export async function GET(request: Request, { params }: RouteContext) {
  ...
  return Response.json({ submission: await buildPublicSubmissionStatus(submission) });
}
